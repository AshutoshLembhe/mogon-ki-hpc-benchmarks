...
RUN_DATA="${IO500_LUSTRE}/io500-${SLURM_NTASKS}ranks-${SLURM_JOB_ID}"
RUN_RESULTS="${IO500_HOME}/results/io500-${SLURM_NTASKS}ranks-${SLURM_JOB_ID}"
RUN_CONFIG="${IO500_HOME}/config/io500-${SLURM_NTASKS}ranks-${SLURM_JOB_ID}.ini"
